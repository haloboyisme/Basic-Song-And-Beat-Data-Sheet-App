...
def btn4_clicked():
    filenames = filedialog.askopenfilenames(initialdir = "/", title = "Select Image Files", filetypes = (("Image files", "*.jpg;*.jpeg;*.png"), ("All files", "*.*")), multiple = True)
...
background_img = PhotoImage(file = f"AddPage/background.png")
background = canvas.create_image(
    540.0, 360.0,
    image=background_img)

img0 = PhotoImage(file = f"AddPage/img0.png")
b0 = Button(
    image = img0,
    borderwidth = 0,
    highlightthickness = 0,
...
img1 = PhotoImage(file = f"AddPage/img1.png")
b1 = Button(
    image = img1,
    borderwidth = 0,
    highlightthickness = 0,
...
entry0_img = PhotoImage(file = f"AddPage/img_textBox0.png")
...
entry1_img = PhotoImage(file = f"AddPage/img_textBox1.png")
...
entry2_img = PhotoImage(file = f"AddPage/img_textBox2.png")
...
entry3_img = PhotoImage(file = f"AddPage/img_textBox3.png")
...
entry4_img = PhotoImage(file = f"AddPage/img_textBox4.png")
...
img2 = PhotoImage(file = f"AddPage/img2.png")
b2 = Button(
    image = img2,
    borderwidth = 0,
    highlightthickness = 0,
...
entry5_img = PhotoImage(file = f"AddPage/img_textBox5.png")
...
entry6_img = PhotoImage(file = f"AddPage/img_textBox6.png")
...
entry7_img = PhotoImage(file = f"AddPage/img_textBox7.png")
...
entry8_img = PhotoImage(file = f"AddPage/img_textBox8.png")
...
entry9_img = PhotoImage(file = f"AddPage/img_textBox9.png")
...
img3 = PhotoImage(file = f"AddPage/img3.png")
b3 = Button(
    image = img3,
    borderwidth = 0,
    highlightthickness = 0,
...
img4 = PhotoImage(file = f"AddPage/img4.png")
b4 = Button(
    image = img4,
    borderwidth = 0,
    highlightthickness = 0,
